...
class MyPaymentModule extends PaymentModuleCore
{
    ...
    )
    {
        ...
        if (Validate::isLoadedObject($this->context->cart) && $this->context->cart->OrderExists() == false) {
            ...
            // print_r($extra_vars);
            if (isset($extra_vars['reference'])) {
                $reference = $extra_vars['reference'];
            } else {
                do {
            ...
            foreach ($package_list as $id_address => $packageByAddress) {
                foreach ($packageByAddress as $id_package => $package) {
                    ...
                    if (!$nameModule) {
                        if (isset($extra_vars['module'])) {
                            $nameModule = $extra_vars['module'];
                        }
                    }
